    ...
    <div class="container">
        <div class="row">
            ...
            <?php foreach($tickets as $ticket): ?>
                ...
                <div class="col s6 md4 mb-4">
                    <div class="card z-depth-0">
                        <div class="card-content text-center">

                        <h4> Ticket ID: <?php echo htmlspecialchars($ticket['ticket_id']); ?></h4>
                        <h4> Date: <?php echo htmlspecialchars($ticket['date']); ?></h4>
                        <h4> Watch Time: <?php echo htmlspecialchars($ticket['time']); ?></h4>
...
<div class="container container-p-y">
    <h4 class="font-weight-bold pb-2 mb-3 text-center">
      User Settings
    </h4>
        ...
        <div class="col-md">
          <div class="tab-content">
            ...
            <hr class="border-light m-0">
              ...
              <div class="card-body">    
                ...
                <div class="form-group">
                  ...
                  <p class="font-weight-bold text-info"> 0 </p>
                  <label class="form-label">Total Used Points</label>
                  <p class="font-weight-bold text-info"> 0 </p>
                </div>
              </div>
            ...
            <hr class="border-light m-0">
              ...
              <div class="card-body">
                <h6 class="mb-4">Use Points</h6>
                <button type="button" class="btn btn-twitter">Go to <strong>Food</strong></button>
              </div>

              <hr class="border-light m-0">
                
              <div class="card-body">
                <button type="button" class="btn btn-facebook">Go to <strong>Movies</strong></button> 
              </div>
                
            <div class="card-body">
                <label class="form-label">Currently Allocated Points:</label>
                <p class="font-weight-bold text-info"> 0 </p>
            </div>
              ...
              <div class="card-body">
                 <h6 class="mb-4">How to Use Points?</h6>
                <button type="button" class="btn btn-instagram">Go to <strong>FAQ</strong></button>
              </div>
